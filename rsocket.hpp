...
#define rddata_error_state    "RSocket::rddata:  Socket is not connected!"
#define rddata_error_buffer   "RSocket::rddata:  Buffer point is unvalid!"


        class RSocket : public IODevice
        {
                /* :Данный класс осуществляет управление сетевыми сокетами */
